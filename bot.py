...
async def start(event: events.NewMessage.Event):
    await event.reply(
        ...
        "**๏** `/zip` - Sᴛᴀʀᴛ ᴛʜᴇ ᴘʀᴏᴄᴇss ᴏғ ᴄᴏʟʟᴇᴄᴛɪɴɢ ᴘᴅғ ғɪʟᴇs ᴛᴏ ᴢɪᴘ.\n"
        "**๏** `/confirm` - Zɪᴘ ᴀʟʟ ᴄᴏʟʟᴇᴄᴛᴇᴅ ᴘᴅғ ғɪʟᴇs ᴀɴᴅ ʀᴇᴄᴇɪᴠᴇ ᴛʜᴇ ᴢɪᴘᴘᴇᴅ ғɪʟᴇ.\n"
        "**๏** `/unzip` - Rᴇᴘʟʏ ᴛᴏ ᴀ ᴢɪᴘ ғɪʟᴇ ᴛᴏ ᴇxᴛʀᴀᴄᴛ ɪᴛs ᴄᴏɴᴛᴇɴᴛs.",
        link_preview=False,
        buttons=[
